...
Franci_console.exe : make_Zaimoni_STL $(OBJECTS_FRANCI_CONSOLE_LINK_PRIORITY)
	g++ -oFranci_console.exe $(LINK_FLAGS) $(ARCH_FLAGS) $(OBJECTS_FRANCI_CONSOLE) -mconsole -lz_cstdio_console -lz_csvtable -lz_langconf -lz_logging -lz_log_adapter -lz_format_util -lz_stdio_c -lz_memory
